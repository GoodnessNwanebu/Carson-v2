    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <div className="inline-flex items-center gap-2 sm:gap-3 bg-white px-4 sm:px-6 py-2 sm:py-3 rounded-full shadow-sm border border-gray-200 mb-6 sm:mb-8">
            <BookOpen className="w-5 h-5 sm:w-6 sm:h-6 text-blue-600" />
            <span className="text-base sm:text-lg font-semibold text-gray-900">Explorations</span>
          </div>
        ...
        <div className="mb-8 sm:mb-12">
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl sm:rounded-2xl p-6 sm:p-8 text-white relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-blue-100 text-base sm:text-lg mb-4 sm:mb-6 max-w-3xl">
              ...
              <Link
                href="/question-solver"
                className="inline-flex items-center gap-2 bg-white text-blue-600 px-6 sm:px-8 py-3 sm:py-4 rounded-lg sm:rounded-xl font-semibold hover:bg-blue-50 transition-colors group"
              >
                Start Practicing
        ...
        <div className="mb-12 sm:mb-16">
          <div className="text-center mb-8 sm:mb-12">
            <div className="inline-flex items-center gap-2 text-gray-600 mb-3 sm:mb-4">
              <Sparkles className="w-4 h-4 sm:w-5 sm:h-5" />
              <span className="font-medium text-sm sm:text-base">Coming Soon</span>
            </div>
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3 sm:mb-4 px-4">More Tools in Development</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            {explorationTools.slice(1).map((tool) => {
              ...
              return (
                <div
                  key={tool.id}
                  className="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-gray-200 hover:shadow-lg transition-all duration-200 hover:border-gray-300 group"
                >
                  <div className="bg-gray-50 p-3 sm:p-4 rounded-lg sm:rounded-xl mb-4 sm:mb-6 group-hover:bg-gray-100 transition-colors">
                  ...
                  <div className="space-y-1.5 sm:space-y-2 mb-6 sm:mb-8">
                    {tool.features.map((feature, index) => (
                      <div key={index} className="flex items-center gap-2 sm:gap-3 text-xs sm:text-sm text-gray-600">
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg sm:rounded-xl px-3 sm:px-4 py-2 sm:py-3 text-center">
                    <span className="text-yellow-700 font-medium text-xs sm:text-sm">Coming Soon</span>
                  </div>
                </div>
              );
            })}
